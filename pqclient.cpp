/*
 *This file is the client side/use of the PQArray library
 *that was made
 */
#include "pqclient.h"
#include "pqarray.h"
...
/*
 * Reads a stream of DataPoints and returns a Vector containing
 * the top k elements in decreasing order of priority.
 */
...
STUDENT_TEST("topK: small fixed input") {
...
STUDENT_TEST("topK: time trial, constant k") {
    int nStartSize = 2000000;
    int k = 100;
    for (int n = nStartSize; n < 10*nStartSize; n *= 2) {
